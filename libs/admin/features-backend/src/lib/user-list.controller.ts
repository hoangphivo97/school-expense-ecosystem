...
export class UserListController {
  ...
  async manualAccountProvisioning(@Body() createUserDto: CreateUserDto): Promise<CreateUserResult> {
    return this.userListService.provisionNewUserByAdmin(createUserDto);
  }
}